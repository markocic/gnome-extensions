...
class OsdWidget extends St.Bin {
    ...
    _updateStyle() {
        const pos = this._settings.get_int('stylish-osd-position');
        const vertical = this._settings.get_boolean('stylish-osd-vertical');
        const width = this._settings.get_int('stylish-osd-width');
        const height = this._settings.get_int('stylish-osd-height');
        const padding = this._settings.get_int('stylish-osd-padding');
        const margin_y = this._settings.get_int('stylish-osd-margin-y');
        const margin_x = this._settings.get_int('stylish-osd-margin-x');
        const radii = this._settings.get_int('stylish-osd-roundness');
